...
public class PrintCalendar {
	...
	// Print the calendar from a month in a year
	...
	// Print the month title, e.g., 2018
	...
	// Pad spave before the first day of the month
	int i = 0;
	...
	//get the startof the month/1/year
	public static int getStartDay(int year, int month) {
		final int START_DAY_FOR_JAN_1_1800 = 3;
		// Get total number of days from 1/1/1800 to monh/1/year
	...
	// Get the total number of days sine January 1, 1800
	...
	// A stub for get<onthName may lok like this
	//public static String getMonthName(int month) {
